      ...
      <div className="p-4 h-full">
        ...
        <div className="mt-4 flex justify-center">
          <button
            ...
            className="hb-btn text-gray-900 py-1 px-4 rounded border text-white bg-[#2d7da0] hb-border-primary hover:text-white"
          >
            <span className="hb-btn-text">Discover More &nbsp;</span>
          </button>
        </div>
      </div>
    </div>
